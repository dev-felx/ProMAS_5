           ...
           if($user_data['data'] != NULL){
            ...
            if($result){
                   ...
                   if($email_result){
                       ...
                       $data['message'] = "<div class='alert alert-success fade in text-center'> A link has been sent, Check your email.</div>";
                           ...
                           if($_POST['password'] == $_POST['password_con']){
                               ...
                               if($user_type == 'student'){
                                   ...
                                   if($user_data['data'] != NULL){
                                        ...
                                        $data['user_id'] =$user_id;
                                        $data['user_type']=$user_type;
                                        $data['message']= "<div class='alert alert-success fade in text-center'>Password changed successfull,You can login</div>";
                                        $this->load->view("access/change_password", $data);
